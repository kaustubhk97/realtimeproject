...
namespace realtimeproject
{
    public partial class WebForm7 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            double wamt = Convert.ToDouble(TextBox4.Text);
            ...
            string q = "update custreg set depoamt=depoamt-'" + wamt + "' where cid='" + TextBox1.Text + "'";
            ...
            {
                Label1.Visible = true;
                Label1.Text = "Your Withdrawal was successful Enjoy ";
            }
            else
            {
